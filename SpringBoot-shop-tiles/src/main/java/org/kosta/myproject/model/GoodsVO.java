...
public String getMiddlecateCode() {
	return middlecateCode;
}

public void setMiddlecateCode(String middlecateCode) {
	this.middlecateCode = middlecateCode;
}
